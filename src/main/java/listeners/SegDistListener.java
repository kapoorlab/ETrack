...
public class SegDistListener implements AdjustmentListener {
	final Label label;
	final String string;
	...
	public SegDistListener(final InteractiveEmbryo parent, final Label label, final String string, final float min,
