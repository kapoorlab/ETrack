...
public class InteractiveEmbryo extends JPanel implements PlugIn {
	...
	public HashMap<String, ArrayList<Embryoobject>> Finalcurvatureresult;
	...
	public ArrayList<Pair<String, ArrayList<Embryoobject>>> Tracklist;
	...
	public void run(String arg0) {
		...
		Tracklist = new ArrayList<Pair<String, ArrayList<Embryoobject>>>();
